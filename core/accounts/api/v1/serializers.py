...
from django.contrib.auth.password_validation import validate_password  # Django's built-in password strength validator
...
class RegistrationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['email', 'password', 'password1']  # Fields that will be accepted in the API
